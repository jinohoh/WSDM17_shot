...
for iter = 1:maxiters
    ...
    for n = dimorder(1:end)
        ...
        [U{n}, d] = nvecs(Utilde,n,R(n));
        fprintf(['Iter %2d, mode %2d, Eigenvalues: ' repmat('%f ', size(diag(d)')) '\n'], iter, n, diag(d)');
    end
...
%     fprintf('Iter %2d: %e %e %7.1e\n', iter, toc, fit, fitchange);
    fprintf('Iter %2d: %e %e %7.1e (%e - %e) \n', iter, toc, fit, fitchange, normX^2, norm(core)^2);
